...
Console.WriteLine($"vege based menu, no coupon: {vegetarianMenu.CalculatePrice()} euro.");


vegetarianMenu = new VegetarianMenu(oneEuroCoupon);
Console.WriteLine($"vege based menu, one euro coupon: {vegetarianMenu.CalculatePrice()} euro.");
